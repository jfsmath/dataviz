...
subtitle: "Visualizing Data Distribution"
...
```{r}
library(patchwork)
p1 <- ggplot(gapminder, aes(lifeExp)) + 
...
**Exercise:** Look up `?geom_col` and recreate the plot using one long pipeline (hint: summarize). \pause
