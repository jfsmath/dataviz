...
p <- ggplot(gapminder, 
  ...
  labs(
    ...
    fill = "Continent", 
    title = "Life expectancy of each continent", 
...
## Overlaying other geometries on `geom_box()`


**Exercise:** I want to overlay a line plot with the boxplot, where each line corresponds to a subject. How to fix the following code?
...
## Summary: `geom_` doing statistics for us
