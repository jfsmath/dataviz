...
- For this lecture:
```
install.packages(c("corrplot", "ggcorrplot", "GGally", "factoextra", "rattle", "ggbiplot"))
```
...
- Very popular linear **dimension reduction techniques**
...
- **Possible Interpretation:** PC1 captures petal l/w and sepal l, while PC2 captures sepal width