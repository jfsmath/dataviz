...
```{r, echo = F, fig.cap='Charles Joseph Minard: Napoleon’s retreat from Moscow in 1812', out.width="100%"}
knitr::include_graphics("images/02_minrad.png")
```

=======
>>>>>>> 5bdc17fb5bfd9c95e5e3f7625aabf4019b0c4ac6
...
```{r, fig.cap='Charles Joseph Minard: Napoleon’s retreat from Moscow in 1812', out.width="100%", echo = F}
knitr::include_graphics("images/02_minrad.png")
```
