...
=======
## An iconic infographics

```{r, fig.cap='Napoleon’s retreat from Moscow in 1812 by Charles Joseph Minard', out.width="100%", echo = F}
>>>>>>> Stashed changes
knitr::include_graphics("images/02_minrad.png")
```
Minard: 1781-1870, French civil engineer, noted for infographics in civil engineering and statistics
...
## Fundamental function: Graphics should **reveal** data
...
```{r, out.width="50%", fig.align='center', fig.cap='"The impact of outliers on income inequality" by Robert W. Jackman, in response to Hewitt (1977)', echo=FALSE}
...
{\it The number of information-carrying (variable) dimensions depicted should not exceed the number of dimensions in the data. -- Edward Tufte}
...
=======
## What Could Go Wrong? Bad Models and Bad Data
>>>>>>> Stashed changes
