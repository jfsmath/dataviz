...
- **Goal**: identify underlying relationships between observed variables. 

- It assumes that observed variables are influenced by a smaller number of unobserved variables called factors. 

- **Example:** Hard to measure "social anxiety". But we can measure whether social anxiety is high or low with a set of variables like 
  - “uncomfortable in large groups” and 
  - “nervous talking with strangers.”
