...
- Wickham, Hadley, Mine Çetinkaya-Rundel, and Garrett Grolemund, [R for data science](https://r4ds.had.co.nz/index.html)  
...
```{r}
pway <-  "https://cdn.rawgit.com/kjhealy/viz-organdata/master/organdonation.csv"
...
Add **legends** and **labels** (I will be **\textcolor{red}{VERY PICK}** about this in your grading). 
```{r, echo = FALSE, out.height="700%", fig.align='center'}
p + geom_point(aes(col = state, size = popdensity)) + 
  labs(
